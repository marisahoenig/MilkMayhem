...
SOURCES            = myLib.c main.c update.c movebackground.c splashscreen.c instructions.c spritesheet.c winscreen.c losescreen1.c losescreen2.c pausescreen.c controls.c uke.c meow.c sounds.c lights.c
